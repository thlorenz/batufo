...
- [ ] offset covered tiles correctly
- [ ] re-enable picture recording and make it work
  - [ ] record entire game area and record
  - [ ] cut out rect matching the visible area from src when drawing it
