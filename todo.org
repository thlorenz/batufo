...
- [ ] pressing it takes us back to select level screen
- [ ] waiting screen should include that button
- [ ] when all players but one exited last player wins and game ends
...
- [ ] additionally clients could send a leave when app is about to be closed
